      ...
      <div className="footer-inner">
        <div className="footer-grid">
              ...
              <div className="footer-social">
                ...
                <Link className="icon-button icon-button-dark footer-social-icon" to="/newsletter" aria-label="Newsletter">
                  <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
                    <path
                      fill="currentColor"
                      d="M4.5 6h15A2.5 2.5 0 0 1 22 8.5v8A2.5 2.5 0 0 1 19.5 19h-15A2.5 2.5 0 0 1 2 16.5v-8A2.5 2.5 0 0 1 4.5 6Zm0 2v.3l7.2 4.5a.6.6 0 0 0 .6 0L19.5 8.3V8h-15Zm15 2.7-6.2 3.9a2.6 2.6 0 0 1-2.6 0L4.5 10.7v5.8c0 .3.2.5.5.5h14c.3 0 0 .5-.2.5v-5.8Z"
                    />
                  </svg>
                </Link>
              </div>
          ...
          <ul className="footer-list">
            ...
            <li><Link to="/elementor-7819">From Passion to Purpose: Pooja&apos;s Journey</Link></li>
          </ul>
        </div>
