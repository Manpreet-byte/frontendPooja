    ...
    <main className="section page-60 page-legal page-privacy page-typography">
      <div className="container">
        ...
        <p>
          ...
          Fab Foods, 1311, Corporate Annexe, next to Udyog Bhavan, Sonawala road, Goregaon East, Mumbai 400063, India.
        </p>
        ...
        <p>
          <strong>Website</strong> refers to Love and Flour By Pooja, accessible from loveandflourbypooja.com
        </p>
        ...
        <p>
          <strong>Necessary / Essential Cookies</strong> Type: Session Cookies Administered by: Us Purpose: These Cookies
          are essential to provide You with services available through the Website and to enable You to use some of its
          features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies,
          the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those
          services.
        </p>

        <p>
          <strong>Cookies Policy / Notice Acceptance Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose:
          These Cookies identify if users have accepted the use of cookies on the Website.
        </p>

        <p>
          <strong>Functionality Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow
        ...
        <ul>
          ...
          <li>
            ...
            a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us
        ...
        <p>
          ...
          from a parent, We may require Your parent’s consent before We collect and use Your information.
        </p>
