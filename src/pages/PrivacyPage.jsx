  ...
  return (
    <main className="section page-60 page-legal page-privacy page-typography">
      <div className="container">
        ...
        <p><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Fab Foods, 1311, Corporate Annexe, next to Udyog Bhavan, Sonawala road, Goregaon East, Mumbai 400063, India.</p>
        ...
        <p><strong>Website</strong> refers to Love and Flour By Pooja, accessible from loveandflourbypooja.com</p>
        ...
        <p><strong>Cookies Policy / Notice Acceptance Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
        <p><strong>Functionality Cookies</strong> Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
        ...
        <p>The Company may disclose Your Personal Data in the good faith and belief that such action is necessary to:</p>
        <ul>
        ...
        <p>If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent’s consent before We collect and use Your information.</p>
